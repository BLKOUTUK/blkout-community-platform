...
export default function TheoryOfChangeMasonry() {
  ...
  const act2Cards: Card[] = [
    ...
    { id: 13, type: 'beauty', size: 'medium', imageUrl: '/images/theory-of-change/card-13-app.png', bgGradient: 'from-violet-950 to-purple-950', content: {} },
    { id: 13.5, type: 'statement', size: 'small', bgGradient: 'from-violet-950 to-purple-950', content: { body: 'No face, no case, no intimacy', subtitle: 'The apps reward sharing as little of yourself as possible to get what you want, not what you need' }, textPosition: 'center' },
