...
export default function TheoryOfChangeMasonry() {
  ...
  const act2Cards: Card[] = [
    ...
    { id: 16, type: 'statement', size: 'large', imageUrl: '/images/theory-of-change/video1-scene2-invisible-walls.png', bgGradient: 'from-violet-950 to-purple-950', content: { body: 'Not being able to find each other means all of us are lost', highlight: 'We are scattered, scrolling from behind faceless profiles, lurking in the GC.' }, textPosition: 'center' },
  ...
  const act4Cards: Card[] = [
    { id: 30, type: 'statement', size: 'large', imageUrl: '/images/theory-of-change/card-30-isolation.png', bgGradient: 'from-indigo-950 to-purple-950', content: { body: 'Activism has won us the freedom to love', highlight: 'Today, we battle to turn love into liberation.' }, animationType: 'default', textPosition: 'topLeft' },
